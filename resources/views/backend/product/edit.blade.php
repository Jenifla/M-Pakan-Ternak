...
<div class="card">
    ...
    <div class="card-body">
      <form method="post" action="{{route('product.update',$product->id)}}" enctype="multipart/form-data">
        ...
        <div class="form-group">
          <label for="weight" class="col-form-label">Weight(gram) <span class="text-danger">*</span></label>
        ...
        <div style="margin-top: 10px; display: flex; flex-wrap: wrap;">
            @foreach ($product->gambarProduk as $gambar)
                <img src="{{ asset($gambar->gambar) }}" alt="Current Photo" style="max-width: 100px; margin-right: 10px;">
            @endforeach
        </div>
        @endif
